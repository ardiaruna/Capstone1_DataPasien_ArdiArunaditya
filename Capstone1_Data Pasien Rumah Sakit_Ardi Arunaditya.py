...
def register_new_patient():
    while True:
        ...
        if option == 1:
            ...
            gender = func_gender("\nInsert The Patient Gender (M/F): ")
            age = func_age("\nInsert The Patient Age: ")
            height = func_height("\nInsert The Patient Height (cm): ")
            weight = func_weight("\nInsert The Patient Weight (kg): ")
...
def sort_patient_data():
    while True:
        print("""
              ...
              """)
        option = func_num("Please Select The Number From The Options Above (1-6): ")
        if option == 1:
